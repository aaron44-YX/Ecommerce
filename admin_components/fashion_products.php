...
$query = "SELECT * FROM fashion_products_tb";
...
<body>
    ...
    <div class="flex justify-end items-center p-4">
        <a href="?page=addfashion_products" class="text-green-700 font-semibold flex items-center active:bg-green-300">
    ...
    <div class="grid grid-cols-3 gap-4 p-4">
        <?php while ($row = mysqli_fetch_assoc($result)): ?>
            <div class="border border-gray-300 p-4 rounded-lg shadow ">
                ...
                <a href="?page=editfashion_products&id=<?= $row['id']; ?>" class="text-green-700">Edit</a>
            </div>
        <?php endwhile; ?>
    </div>
