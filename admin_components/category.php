...
<main class="relative text-center text-white">
        ...
        <div class="relative flex flex-wrap justify-center gap-6 p-10">
            <div class="border border-gray-300 bg-white w-72 h-96 p-4 text-center transform transition-transform hover:scale-105 cursor-pointer">
                <h2 class="font-bold text-gray-700 text-lg">Mobiles Accessories</h2>
                <img src="img/tripod.jpg" alt="" class="w-60 h-72 object-contain mx-auto mt-2">
                <div class="flex justify-around items-center">
                <a href="?page=mobile_products" class="text-green-600 text-sm hover:text-black cursor-pointer">Products</a>
