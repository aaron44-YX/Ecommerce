...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM kitchen_products_tb WHERE id = $id";
...
if (isset($_POST['update'])) {
    ...
    if (!empty($_FILES['image']['name'])) {
        ...
        $updateQuery = "UPDATE kitchen_products_tb SET name='$name', description='$description', quantity='$quantity', price='$price', image='$image' WHERE id=$id";
    } else {
        $updateQuery = "UPDATE kitchen_products_tb SET name='$name', description='$description', quantity='$quantity', price='$price' WHERE id=$id";
    }
...
if (isset($_POST['delete'])) {
    $deleteQuery = "DELETE FROM kitchen_products_tb WHERE id=$id";
