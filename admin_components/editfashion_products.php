...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM fashion_products_tb WHERE id = $id";
...
if (isset($_POST['update'])) {
    ...
    if (!empty($_FILES['image']['name'])) {
        ...
        $updateQuery = "UPDATE fashion_products_tb SET name='$name', description='$description', quantity='$quantity', price='$price', image='$image' WHERE id=$id";
    } else {
        $updateQuery = "UPDATE fashion_products_tb SET name='$name', description='$description', quantity='$quantity', price='$price' WHERE id=$id";
    }

    mysqli_query($conn, $updateQuery);
    header('Location: ?page=fashion_products');
    exit;
}

// Handle delete
if (isset($_POST['delete'])) {
    $deleteQuery = "DELETE FROM fashion_products_tb WHERE id=$id";
