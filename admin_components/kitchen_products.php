...
$query = "SELECT * FROM kitchen_products_tb";
...
<body>
    ...
    <div class="flex justify-end items-center p-4">
        <a href="?page=addkitchen_products" class="text-green-700 font-semibold flex items-center active:bg-green-300">
    ...
    <div class="grid grid-cols-3 gap-4 p-4">
        <?php while ($row = mysqli_fetch_assoc($result)): ?>
            <div class="border border-gray-300 p-4 rounded-lg shadow ">
                ...
                <a href="?page=editkitchen_products&id=<?= $row['id']; ?>" class="text-green-700">Edit</a>
            </div>
        <?php endwhile; ?>
    </div>
