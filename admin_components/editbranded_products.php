...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM branded_products_tb WHERE id = $id";
...
if (isset($_POST['update'])) {
    ...
    if (!empty($_FILES['image']['name'])) {
        ...
        $updateQuery = "UPDATE branded_products_tb SET name='$name', description='$description', quantity='$quantity', price='$price', image='$image' WHERE id=$id";
    } else {
        $updateQuery = "UPDATE branded_products_tb SET name='$name', description='$description', quantity='$quantity', price='$price' WHERE id=$id";
    }

    mysqli_query($conn, $updateQuery);
    header('Location: ?page=branded_products');
    exit;
}

// Handle delete
if (isset($_POST['delete'])) {
    $deleteQuery = "DELETE FROM branded_products_tb WHERE id=$id";
