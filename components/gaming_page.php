...
?>
    ...
    <div class="grid grid-cols-3 gap-4 p-4">
        ...
        <a href="product_layout.php?category=gaming&id=<?= $row['id']; ?>" class="block bg-white p-4 rounded-lg shadow hover:scale-105 transform transition-transform cursor-pointer">
