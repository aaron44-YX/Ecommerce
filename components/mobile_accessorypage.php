...
?>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4">
      ...
      <a href="product_layout.php?category=mobile_products_tb&id=<?= $row['id']; ?>" class="block bg-white p-4 rounded-lg shadow hover:scale-105 transform transition-transform cursor-pointer">
